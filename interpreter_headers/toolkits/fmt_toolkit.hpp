// Author: Jordan Randleman -- jrandleman@scu.edu -- fmt_toolkit.hpp
...
#ifndef FMT_TOOLKIT_HPP_
#define FMT_TOOLKIT_HPP_

data prm_generate_ANSI_fmt_string(const char* name, const data_vector& args, const char* ansi_str){
...
data primitive_fmt_reset(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:reset",args,"\x1b[0m");}

// clear current screen
data primitive_fmt_clear(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:clear",args,"\x1b[2J");}
...
data primitive_fmt_bold(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bold",args,"\x1b[1m");}
data primitive_fmt_line(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:line",args,"\x1b[4m");}
data primitive_fmt_rev(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:rev",args,"\x1b[7m");}
...
data primitive_fmt_black(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:black",args,"\x1b[30m");}
data primitive_fmt_red(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:red",args,"\x1b[31m");}
data primitive_fmt_green(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:green",args,"\x1b[32m");}
data primitive_fmt_yellow(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:yellow",args,"\x1b[33m");}
data primitive_fmt_blue(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:blue",args,"\x1b[34m");}
data primitive_fmt_magenta(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:magenta",args,"\x1b[35m");}
data primitive_fmt_cyan(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:cyan",args,"\x1b[36m");}
data primitive_fmt_white(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:white",args,"\x1b[37m");}

// each of 8 basic fmts extended along their own 8 gradients
// from 1 = dark, to 8 = bright
data primitive_fmt_black1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:black1",args,"\x1b[38;5;0m");}
data primitive_fmt_black2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:black2",args,"\x1b[38;5;233m");}
data primitive_fmt_black3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:black3",args,"\x1b[38;5;234m");}
data primitive_fmt_black4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:black4",args,"\x1b[38;5;235m");}
data primitive_fmt_black5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:black5",args,"\x1b[38;5;237m");}
data primitive_fmt_black6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:black6",args,"\x1b[38;5;238m");}
data primitive_fmt_black7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:black7",args,"\x1b[38;5;239m");}
data primitive_fmt_black8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:black8",args,"\x1b[38;5;8m");}
data primitive_fmt_red1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:red1",args,"\x1b[38;5;52m");}
data primitive_fmt_red2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:red2",args,"\x1b[38;5;88m");}
data primitive_fmt_red3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:red3",args,"\x1b[38;5;1m");}
data primitive_fmt_red4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:red4",args,"\x1b[38;5;124m");}
data primitive_fmt_red5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:red5",args,"\x1b[38;5;160m");}
data primitive_fmt_red6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:red6",args,"\x1b[38;5;9m");}
data primitive_fmt_red7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:red7",args,"\x1b[38;5;196m");}
data primitive_fmt_red8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:red8",args,"\x1b[38;5;197m");}
data primitive_fmt_green1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:green1",args,"\x1b[38;5;22m");}
data primitive_fmt_green2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:green2",args,"\x1b[38;5;28m");}
data primitive_fmt_green3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:green3",args,"\x1b[38;5;70m");}
data primitive_fmt_green4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:green4",args,"\x1b[38;5;40m");}
data primitive_fmt_green5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:green5",args,"\x1b[38;5;82m");}
data primitive_fmt_green6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:green6",args,"\x1b[38;5;118m");}
data primitive_fmt_green7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:green7",args,"\x1b[38;5;119m");}
data primitive_fmt_green8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:green8",args,"\x1b[38;5;156m");}
data primitive_fmt_yellow1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:yellow1",args,"\x1b[38;5;208m");}
data primitive_fmt_yellow2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:yellow2",args,"\x1b[38;5;214m");}
data primitive_fmt_yellow3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:yellow3",args,"\x1b[38;5;220m");}
data primitive_fmt_yellow4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:yellow4",args,"\x1b[38;5;226m");}
data primitive_fmt_yellow5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:yellow5",args,"\x1b[38;5;227m");}
data primitive_fmt_yellow6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:yellow6",args,"\x1b[38;5;228m");}
data primitive_fmt_yellow7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:yellow7",args,"\x1b[38;5;229m");}
data primitive_fmt_yellow8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:yellow8",args,"\x1b[38;5;230m");}
data primitive_fmt_blue1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:blue1",args,"\x1b[38;5;17m");}
data primitive_fmt_blue2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:blue2",args,"\x1b[38;5;18m");}
data primitive_fmt_blue3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:blue3",args,"\x1b[38;5;19m");}
data primitive_fmt_blue4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:blue4",args,"\x1b[38;5;4m");}
data primitive_fmt_blue5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:blue5",args,"\x1b[38;5;20m");}
data primitive_fmt_blue6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:blue6",args,"\x1b[38;5;21m");}
data primitive_fmt_blue7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:blue7",args,"\x1b[38;5;12m");}
data primitive_fmt_blue8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:blue8",args,"\x1b[38;5;27m");}
data primitive_fmt_magenta1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:magenta1",args,"\x1b[38;5;54m");}
data primitive_fmt_magenta2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:magenta2",args,"\x1b[38;5;90m");}
data primitive_fmt_magenta3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:magenta3",args,"\x1b[38;5;127m");}
data primitive_fmt_magenta4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:magenta4",args,"\x1b[38;5;164m");}
data primitive_fmt_magenta5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:magenta5",args,"\x1b[38;5;13m");}
data primitive_fmt_magenta6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:magenta6",args,"\x1b[38;5;207m");}
data primitive_fmt_magenta7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:magenta7",args,"\x1b[38;5;213m");}
data primitive_fmt_magenta8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:magenta8",args,"\x1b[38;5;183m");}
data primitive_fmt_cyan1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:cyan1",args,"\x1b[38;5;30m");}
data primitive_fmt_cyan2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:cyan2",args,"\x1b[38;5;6m");}
data primitive_fmt_cyan3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:cyan3",args,"\x1b[38;5;37m");}
data primitive_fmt_cyan4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:cyan4",args,"\x1b[38;5;80m");}
data primitive_fmt_cyan5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:cyan5",args,"\x1b[38;5;14m");}
data primitive_fmt_cyan6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:cyan6",args,"\x1b[38;5;51m");}
data primitive_fmt_cyan7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:cyan7",args,"\x1b[38;5;123m");}
data primitive_fmt_cyan8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:cyan8",args,"\x1b[38;5;159m");}
data primitive_fmt_white1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:white1",args,"\x1b[38;5;242m");}
data primitive_fmt_white2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:white2",args,"\x1b[38;5;244m");}
data primitive_fmt_white3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:white3",args,"\x1b[38;5;248m");}
data primitive_fmt_white4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:white4",args,"\x1b[38;5;7m");}
data primitive_fmt_white5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:white5",args,"\x1b[38;5;252m");}
data primitive_fmt_white6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:white6",args,"\x1b[38;5;15m");}
data primitive_fmt_white7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:white7",args,"\x1b[38;5;255m");}
data primitive_fmt_white8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:white8",args,"\x1b[38;5;231m");}
...
// basic 8 fmts, standard amongst even basic terminals:
data primitive_fmt_bblack(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblack",args,"\x1b[40m");}
data primitive_fmt_bred(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bred",args,"\x1b[41m");}
data primitive_fmt_bgreen(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bgreen",args,"\x1b[42m");}
data primitive_fmt_byellow(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:byellow",args,"\x1b[43m");}
data primitive_fmt_bblue(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblue",args,"\x1b[44m");}
data primitive_fmt_bmagenta(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bmagenta",args,"\x1b[45m");}
data primitive_fmt_bcyan(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bcyan",args,"\x1b[46m");}
data primitive_fmt_bwhite(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bwhite",args,"\x1b[47m");}

// each of 8 basic fmts extended along their own 8 gradients
// from 1 = dark, to 8 = bright
data primitive_fmt_bblack1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblack1",args,"\x1b[48;5;0m");}
data primitive_fmt_bblack2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblack2",args,"\x1b[48;5;233m");}
data primitive_fmt_bblack3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblack3",args,"\x1b[48;5;234m");}
data primitive_fmt_bblack4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblack4",args,"\x1b[48;5;235m");}
data primitive_fmt_bblack5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblack5",args,"\x1b[48;5;237m");}
data primitive_fmt_bblack6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblack6",args,"\x1b[48;5;238m");}
data primitive_fmt_bblack7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblack7",args,"\x1b[48;5;239m");}
data primitive_fmt_bblack8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblack8",args,"\x1b[48;5;8m");}
data primitive_fmt_bred1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bred1",args,"\x1b[48;5;52m");}
data primitive_fmt_bred2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bred2",args,"\x1b[48;5;88m");}
data primitive_fmt_bred3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bred3",args,"\x1b[48;5;1m");}
data primitive_fmt_bred4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bred4",args,"\x1b[48;5;124m");}
data primitive_fmt_bred5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bred5",args,"\x1b[48;5;160m");}
data primitive_fmt_bred6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bred6",args,"\x1b[48;5;9m");}
data primitive_fmt_bred7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bred7",args,"\x1b[48;5;196m");}
data primitive_fmt_bred8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bred8",args,"\x1b[48;5;197m");}
data primitive_fmt_bgreen1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bgreen1",args,"\x1b[48;5;22m");}
data primitive_fmt_bgreen2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bgreen2",args,"\x1b[48;5;28m");}
data primitive_fmt_bgreen3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bgreen3",args,"\x1b[48;5;70m");}
data primitive_fmt_bgreen4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bgreen4",args,"\x1b[48;5;40m");}
data primitive_fmt_bgreen5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bgreen5",args,"\x1b[48;5;82m");}
data primitive_fmt_bgreen6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bgreen6",args,"\x1b[48;5;118m");}
data primitive_fmt_bgreen7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bgreen7",args,"\x1b[48;5;119m");}
data primitive_fmt_bgreen8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bgreen8",args,"\x1b[48;5;156m");}
data primitive_fmt_byellow1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:byellow1",args,"\x1b[48;5;208m");}
data primitive_fmt_byellow2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:byellow2",args,"\x1b[48;5;214m");}
data primitive_fmt_byellow3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:byellow3",args,"\x1b[48;5;220m");}
data primitive_fmt_byellow4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:byellow4",args,"\x1b[48;5;226m");}
data primitive_fmt_byellow5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:byellow5",args,"\x1b[48;5;227m");}
data primitive_fmt_byellow6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:byellow6",args,"\x1b[48;5;228m");}
data primitive_fmt_byellow7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:byellow7",args,"\x1b[48;5;229m");}
data primitive_fmt_byellow8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:byellow8",args,"\x1b[48;5;230m");}
data primitive_fmt_bblue1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblue1",args,"\x1b[48;5;17m");}
data primitive_fmt_bblue2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblue2",args,"\x1b[48;5;18m");}
data primitive_fmt_bblue3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblue3",args,"\x1b[48;5;19m");}
data primitive_fmt_bblue4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblue4",args,"\x1b[48;5;4m");}
data primitive_fmt_bblue5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblue5",args,"\x1b[48;5;20m");}
data primitive_fmt_bblue6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblue6",args,"\x1b[48;5;21m");}
data primitive_fmt_bblue7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblue7",args,"\x1b[48;5;12m");}
data primitive_fmt_bblue8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bblue8",args,"\x1b[48;5;27m");}
data primitive_fmt_bmagenta1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bmagenta1",args,"\x1b[48;5;54m");}
data primitive_fmt_bmagenta2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bmagenta2",args,"\x1b[48;5;90m");}
data primitive_fmt_bmagenta3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bmagenta3",args,"\x1b[48;5;127m");}
data primitive_fmt_bmagenta4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bmagenta4",args,"\x1b[48;5;164m");}
data primitive_fmt_bmagenta5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bmagenta5",args,"\x1b[48;5;13m");}
data primitive_fmt_bmagenta6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bmagenta6",args,"\x1b[48;5;207m");}
data primitive_fmt_bmagenta7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bmagenta7",args,"\x1b[48;5;213m");}
data primitive_fmt_bmagenta8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bmagenta8",args,"\x1b[48;5;183m");}
data primitive_fmt_bcyan1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bcyan1",args,"\x1b[48;5;30m");}
data primitive_fmt_bcyan2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bcyan2",args,"\x1b[48;5;6m");}
data primitive_fmt_bcyan3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bcyan3",args,"\x1b[48;5;37m");}
data primitive_fmt_bcyan4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bcyan4",args,"\x1b[48;5;80m");}
data primitive_fmt_bcyan5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bcyan5",args,"\x1b[48;5;14m");}
data primitive_fmt_bcyan6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bcyan6",args,"\x1b[48;5;51m");}
data primitive_fmt_bcyan7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bcyan7",args,"\x1b[48;5;123m");}
data primitive_fmt_bcyan8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bcyan8",args,"\x1b[48;5;159m");}
data primitive_fmt_bwhite1(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bwhite1",args,"\x1b[48;5;242m");}
data primitive_fmt_bwhite2(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bwhite2",args,"\x1b[48;5;244m");}
data primitive_fmt_bwhite3(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bwhite3",args,"\x1b[48;5;248m");}
data primitive_fmt_bwhite4(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bwhite4",args,"\x1b[48;5;7m");}
data primitive_fmt_bwhite5(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bwhite5",args,"\x1b[48;5;252m");}
data primitive_fmt_bwhite6(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bwhite6",args,"\x1b[48;5;15m");}
data primitive_fmt_bwhite7(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bwhite7",args,"\x1b[48;5;255m");}
data primitive_fmt_bwhite8(data_vector& args){return prm_generate_ANSI_fmt_string("fmt:bwhite8",args,"\x1b[48;5;231m");}
