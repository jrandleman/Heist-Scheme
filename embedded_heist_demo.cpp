// Author: Jordan Randleman -- jrandleman@scu.edu -- embedded_heist_test.cpp
...
// Heist C++ primtive signature: heist::data(*)(heist::scm_list&)
heist::data my_factorial(heist::scm_list& args){ // C++ Hiest User-Defined Primitive
