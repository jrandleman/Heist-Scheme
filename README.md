...
1. [`eval`](#evalapply-symbol-append-typeof--id) alternative in [`scm->cps`](#scm-cps) blocks: [`cps-eval`](#evalapply-symbol-append-typeof--id)
...
#### Analysis-Time Advantanges:
  * Interpreter's [`eval`](#evalapply-symbol-append-typeof--id) seperates expression analysis (declaration) & execution (invocation):
...
* _Enables use of [`call/cc`](#scm-cps-procedures), [`cps-eval`](#evalapply-symbol-append-typeof--id), [`cps-load`](#system-interface-procedures), & [`cps->scm`](#scm-cps-procedures) primitives!_
...
7. __Optional Environment Arg Flags for [`Eval`](#evalapply-symbol-append-typeof--id), [`Load`](#system-interface-procedures), [`Cps-Eval`](#evalapply-symbol-append-typeof--id), [`Cps-Load`](#system-interface-procedures):__
